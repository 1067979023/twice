<?php
    ...
    $sort = isset($_REQUEST['sort']) ? $_REQUEST['sort'] : '';//每页几条数据
    /*
    ...
    */
    ...
    $index = ($page - 1) * $num;
    if($sort == 'true'){
        $sql = "SELECT * FROM list ORDER BY nprice DESC LIMIT $index,$num";
    }else{
        $sql = "SELECT * FROM list ORDER BY nprice ASC LIMIT $index,$num";
    }
